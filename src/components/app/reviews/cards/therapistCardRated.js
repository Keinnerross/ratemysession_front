...
export default function TherapistCardRated({
  ...
  const reactionButtons = [
    ...
    { key: "helpful", icon: AiFillHeart, color: "#EF4444", label: "Loved" },
    { key: "insightful", icon: FaPray, color: "#8B5CF6", label: "Thankful" },
    { key: "inappropriate", icon: HiEmojiSad, color: "#3B82F6", label: "Oh no!" },
  ];
