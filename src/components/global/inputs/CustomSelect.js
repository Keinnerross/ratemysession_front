  ...
  return (
    <div ref={selectRef} className="relative">
      <button
        ...
        className={`
          w-full py-2 px-5 pr-10 
          border ${hasActiveValue ? 'border-[#7466f2] bg-[#f8f7ff]' : 'border-gray-300 bg-white'}
        ...
        `}
      >
        <span className={`block truncate text-left ${hasActiveValue ? 'text-[#7466f2] font-medium' : ''}`}>
